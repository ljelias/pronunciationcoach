...
class VowelContrastsContextProvider extends Component {
  state = { 
    ...
    shortUShortOO: {
      ...
      quizAudio: '',
      practiceAudio: '',
      vowelNotes: ['The tongue must be relaxed for both of these vowels', 'Short-u is in the middle of the mouth at mid height', 'Short-oo is in the upper back part of the mouth, with a RELAXED tongue', 'Some frequently used words with Short-oo: "put", "should", "would", "could", "push", "sugar", "look", "good", "book", "took"'],
      OneA: 'stud',
      OneB: 'stood',
      OneAns: 'stood',
      TwoA: 'huff',
